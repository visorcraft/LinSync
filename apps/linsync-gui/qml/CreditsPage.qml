...
Kirigami.ScrollablePage {
    ...
    // BEGIN GENERATED CREDITS (do not edit inside; run `just credits-update`)
        ...
        { name: "const-oid",                  version: "0.10.2",     license: "Apache-2.0 OR MIT" },
        ...
        { name: "crypto-common",                  version: "0.2.2",     license: "MIT OR Apache-2.0" },
        ...
        { name: "digest",                  version: "0.11.3",     license: "MIT OR Apache-2.0" },
        ...
        { name: "hybrid-array",                  version: "0.4.12",     license: "MIT OR Apache-2.0" },
        ...
        { name: "log",                  version: "0.4.32",     license: "MIT OR Apache-2.0" },
        { name: "memchr",                  version: "2.8.2",     license: "Unlicense OR MIT" },
        ...
        { name: "regex",                  version: "1.12.4",     license: "MIT OR Apache-2.0" },
        { name: "regex-automata",                  version: "0.4.14",     license: "MIT OR Apache-2.0" },
        { name: "regex-syntax",                  version: "0.8.11",     license: "MIT OR Apache-2.0" },
        ...
        { name: "seccompiler",                  version: "0.5.0",     license: "Apache-2.0 OR BSD-3-Clause" },
        ...
        { name: "sha2",                  version: "0.11.0",     license: "MIT OR Apache-2.0" },
        { name: "sharded-slab",                  version: "0.1.7",     license: "MIT" },
        { name: "shlex",                  version: "2.0.1",     license: "MIT OR Apache-2.0" },
        { name: "simd-adler32",                  version: "0.3.9",     license: "MIT" },
        { name: "smallvec",                  version: "1.15.2",     license: "MIT OR Apache-2.0" },
        { name: "static_assertions",                  version: "1.1.0",     license: "MIT OR Apache-2.0" },
        { name: "syn",                  version: "2.0.118",     license: "MIT OR Apache-2.0" },
        ...
        { name: "unicode-segmentation",                  version: "1.13.3",     license: "MIT OR Apache-2.0" },
        ...
        { name: "zerocopy",                  version: "0.8.52",     license: "BSD-2-Clause OR Apache-2.0 OR MIT" },
        { name: "zerocopy-derive",                  version: "0.8.52",     license: "BSD-2-Clause OR Apache-2.0 OR MIT" },
