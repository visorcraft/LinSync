...
pub use plugin::{
    ...
    PluginTextResult, RenderPagesResponse, SandboxStatus, UnpackFolderResponse, VirtualNode,
    active_sandbox_status, clear_plugin_option, compare_archives_with_unpacker,
    discover_installed_plugins, discover_plugins, install_plugin, is_plugin_trusted,
    is_stable_plugin_id, load_plugin_enabled_map, load_plugin_options, load_plugin_trusted_map,
    plugin_discovery_roots, probe_plugin, remove_plugin, resolve_enabled_prediffer,
    resolve_enabled_prediffers, resolve_enabled_virtualizer_for_extension, run_plugin_helper,
